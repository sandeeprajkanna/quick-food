                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 px-0">
                      ...
                      <p className="">
                        <small>
                          Type of Foods:{" "}
                          <span>
                            {restaurantList[val].typeOfFood.join(", ")}
                          </span>
                        </small>
                      </p>
                    </div>
                    <div className="col-lg-3 col-md-3 col-sm-12 py-4 px-0">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          this.handleViewMenuBtn(restaurantList[val])
                        }
                        className="btn btn-warning btn-sm text-uppercase"
                        style={{ marginBottom: "8px" }}
                      >
                      ...
                      <li>
                        <div className="custom-control custom-checkbox">
                          <input
                            ...
                            onChange={this.handleCategoriesCheckbox}
                          />
                          <label className="custom-control-label" htmlFor="bbq">
                            BB.Q
                          </label>
                        </div>
                      </li>
