          ...
          <div className="">
            ...
            <div className="container home-cont1-text">
              <h1 className="h1 text-uppercase text-white text-center mb-4">
                <strong>
                  Organic Fast Food Made <br /> Easy And Healthy
                </strong>
              </h1>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 col-lg-4 col-md-4 px-5">
                ...
                <p className="mb-4">
                  Dictum velit. Duis at purus enim. Cras massa massa, maximus
                  sit amet finibus quis, pharetra eu erat.
                </p>
              </div>
              <div className="col-12 col-lg-4 col-md-4 px-5">
                <span className="round-border my-4">
                ...
                <p className="mb-4">
                  Purus enim. Cras massa massa, maximus sit amet finibus quis,
                  pharetra eu erat.
                </p>
              </div>
            </div>
